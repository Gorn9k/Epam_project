...
import airplane.service.logic.BrigadeServiceImpl;
...
public class BrigadeView {
    ...
    public BrigadeView() throws ConnectorException {
        scanner = new Scanner(System.in);
        brigadeService = new BrigadeServiceImpl(new BrigadeDaoImpl(Connector.getConnecting()), new PersonDaoImpl(Connector.getConnecting()));
